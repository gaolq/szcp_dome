...
public class AdminUserServiceImpl implements DbAdminUserService {
	...
	@Override
	public Map findAdminUserAllInfoById(Integer adminUserId) {
		return adminUserMapper.findAdminUserAllInfoById(adminUserId);
	}
	...
	@Override
	public int updatePasswordAdminUser(DbAdminUser adminUser) {
		return adminUserMapper.updatePasswordAdminUser(adminUser);
	}
